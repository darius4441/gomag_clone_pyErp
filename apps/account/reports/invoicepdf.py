...
def invoice_pdf(request, pk):
    ...
    data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", invoice.amount_untaxed, grouping=True, monetary=True
            ),
        ]
    )
    data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", invoice.amount_exempt, grouping=True, monetary=True
            ),
        ]
    )
    data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", invoice.amount_tax_iva, grouping=True, monetary=True
            ),
        ]
    )
    data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", invoice.amount_tax_other, grouping=True, monetary=True
            ),
        ]
    )
    data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", invoice.amount_tax_total, grouping=True, monetary=True
            ),
        ]
    )
    data_foot.append(
        [
            ...
            _("Total") + ":",
            "$ "
            + locale.format("%.2f", invoice.amount_total, grouping=True, monetary=True),
        ]
    )
