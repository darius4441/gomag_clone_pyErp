...
def sale_order_pdf(request, pk):
    ...
    table = Table(_data_header, colWidths=[7 * cm, 3 * cm, 3 * cm, 3 * cm, 3.5 * cm])
    table.setStyle(
        TableStyle(
            [
    ...
    if _products:
        ...
        for _product in _products:
            _data_table.append(
                [
                    ...
                    _product.discount,
                    locale.format(
                        "%.2f", _product.amount_total, grouping=True, monetary=True
                    ),
                ]
            )
            _high = _high - 18
        ...
        table = Table(_data_table, colWidths=[7 * cm, 3 * cm, 3 * cm, 3 * cm, 3.5 * cm])
        table.setStyle(
            TableStyle(
                [
                    # ('INNERGRID', (0, 0), (-1, -1), 0.25, colors.black),
    ...
    _data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", _sale_order.amount_untaxed, grouping=True, monetary=True
            ),
        ]
    )
    _data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", _sale_order.amount_exempt, grouping=True, monetary=True
            ),
        ]
    )
    _data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", _sale_order.amount_tax_iva, grouping=True, monetary=True
            ),
        ]
    )
    _data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", _sale_order.amount_tax_other, grouping=True, monetary=True
            ),
        ]
    )
    _data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", _sale_order.amount_tax_total, grouping=True, monetary=True
            ),
        ]
    )
    _data_foot.append(
        [
            ...
            "$ "
            + locale.format(
                "%.2f", _sale_order.amount_total, grouping=True, monetary=True
            ),
        ]
    )
    ...
    _high = _high - (18 * 7)
    # Imprimir cuerpo la tabla
    table = Table(_data_foot, colWidths=[11 * cm, 5 * cm, 3.5 * cm])
    table.setStyle(
        TableStyle(
            [
                # ('INNERGRID', (0, 0), (-1, -1), 0.25, colors.black),
